...
@Component({
    ...
    template: ` <div>
        <app-docsectiontext [title]="title" [id]="id">
            <p><i>Angular CLI</i> is the official CLI tool for Angular to create Angular Apps. We strongly suggest using Angular CLI when starting an Angular project.</p>
        </app-docsectiontext>
