...
@Component({
    ...
    template: ` <div>
        ...
        <p>
            ...
            target is an overlay, <i>hideOnOutsideClick</i> would be handy to hide the target if outside of the popup is clicked, or enable <i>hideOnEscape</i> to close the popup by listening <i>escape</i> key.
        </p>
        </app-docsectiontext>
